...
cloud-connector/
  ...
  .goreleaser.yaml     -- Release config: Linux/Windows binaries (386/amd64/arm64), macOS binaries (amd64/arm64)
...
- **Release targets**: GoReleaser builds Linux and Windows binaries for `386`, `amd64`, and `arm64`, plus macOS binaries for `amd64` and `arm64`. The release workflow skips Docker image builds and pushes.
